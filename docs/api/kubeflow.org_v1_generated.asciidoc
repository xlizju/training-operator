...
.Resource Types
- xref:{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjob[$$DeepSpeedJob$$]
- xref:{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjoblist[$$DeepSpeedJobList$$]
...
[id="{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjob"]
==== DeepSpeedJob 
...
| *`spec`* __xref:{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjobspec[$$DeepSpeedJobSpec$$]__ | 
| *`status`* __xref:{anchor_prefix}-github-com-kubeflow-common-pkg-apis-common-v1-jobstatus[$$JobStatus$$]__ | 
|===


[id="{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjoblist"]
==== DeepSpeedJobList 
...
| Field | Description
| *`apiVersion`* __string__ | `kubeflow.org/v1`
| *`kind`* __string__ | `DeepSpeedJobList`
| *`TypeMeta`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#typemeta-v1-meta[$$TypeMeta$$]__ | 
...
| *`items`* __xref:{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjob[$$DeepSpeedJob$$] array__ | 
|===


[id="{anchor_prefix}-github-com-kubeflow-training-operator-pkg-apis-kubeflow-org-v1-deepspeedjobspec"]
==== DeepSpeedJobSpec 
...
| *`runPolicy`* __xref:{anchor_prefix}-github-com-kubeflow-common-pkg-apis-common-v1-runpolicy[$$RunPolicy$$]__ | RunPolicy encapsulates various runtime policies of the job.
| *`deepspeedReplicaSpecs`* __object (keys:ReplicaType, values:ReplicaSpec)__ | DeepSpeedReplicaSpecs contains maps from `DeepSpeedReplicaType` to `ReplicaSpec` that specify the DeepSpeed replicas to run.
| *`sshAuthMountPath`* __string__ | SSHAuthMountPath is the directory where SSH keys are mounted. Defaults to "/root/.ssh".
|===
...
| Field | Description
| *`slotsPerWorker`* __integer__ | Specifies the number of slots per worker used in hostfile. Defaults to 1.
| *`cleanPodPolicy`* __xref:{anchor_prefix}-github-com-kubeflow-common-pkg-apis-common-v1-cleanpodpolicy[$$CleanPodPolicy$$]__ | CleanPodPolicy defines the policy that whether to kill pods after the job completes. Defaults to None.
